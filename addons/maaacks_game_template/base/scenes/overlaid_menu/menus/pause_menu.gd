...
func _on_load_last_save_button_pressed() -> void:
	%ConfirmLoadLastSave.popup_centered()
	popup_open = %ConfirmLoadLastSave
...
func _on_confirm_load_last_save_confirmed() -> void:
	Data._load_current_save()
	Data.game.load_last_save()
	close()
